...
internal class Z
{
    ...
    {
        //using var __ = ObjectPool<object>.Shared.RentLease(out _);
        using var __ = ExactLengthArrayPool<object>.Shared.RentLease(5, true, out _);
    }
    ...
    public static void Main()
    {
        ...
        FastObjectPool<object> pool = FastObjectPool<object>.CreateDefault();
        For(0, 100, _ =>
        {
            Stack<object> q = new();
        ...
        Console.WriteLine("Instance Array Start");
        ...
        Console.WriteLine("Instance Array End");
    ...
    {
        Console.WriteLine(typeof(T));
        SafeObjectPool<T> pool = SafeObjectPool<T>.CreateDefault();
